...
class ColumnModal extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <Modal show={showColumnModal} onHide={toggleColumnModal}>
        <Modal.Header>
          <button type="button" className="close" onClick={toggleColumnModal}>
            <span>&times;</span>
          </button>
          <Modal.Title>{editMode ? "Update Column" : "Add Column"}</Modal.Title>
        </Modal.Header>
        ...
        <Modal.Body>
          ...
          >
            ...
            <div className="form-group">
              <label className="col-xs-3 control-label" htmlFor="type">
                Type:
              </label>
              <div className="col-xs-9">
                <select
            ...
            <div className="form-group">
              <label className="col-xs-3 control-label" htmlFor="length">
                Length:
              </label>
              <div className="col-xs-9">
                <input
            ...
            <div className="form-group">
              <label className="col-xs-3 control-label" htmlFor="comment">
                Comment:
              </label>
              <div className="col-xs-9">
                <input
            ...
            <div className="form-group">
              ...
              <div className="col-xs-9 col-xs-offset-3">
                <label
                  className={classnames("checkbox-inline", {
                    disabled: !isUnsigned
                  })}
                  htmlFor="foreign"
                >
